...
import model.DBTables.Mahasiswa;
import model.DBTables.Prodi;
...
public class KampusApp {
    ...
    public void menuTambah() {
        ...
        Prodi prodi = db.getProdiById(idProdi);
        if (prodi == null) {
            System.out.println("ID Prodi tidak ditemukan. Tidak dapat menambahkan data mahasiswa.");
        } else {
